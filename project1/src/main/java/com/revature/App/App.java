...
public class App {
	...
	public static void main(String[] args) {
		...
		AccDetails accdetails = new AccDetails(name0,phone,address0,Email,balance0);
		...
		case 9:{
			AccountRepository accRepository=new JdbcAccountRepository();
			System.out.println("Enter  accountid to retrieve Email address");
			int n1=input.nextInt();
			accountRepository.getEmailc(n1);
		} 
		}
		}
		else {
